...
public final class MatcherWrapper implements MatchResult {
  ...
  public String replaceAll(Function<? super MatcherWrapper, ? extends String> replaceFunction) {
    checkLocked();
  ...
  public String replaceFirst(Function<? super MatcherWrapper, ? extends String> replaceFunction) {
